...
for (const key of ['version', 'description', 'repository', 'author', 'license', 'peerDependencies', 'dependencies']) {
    distPkg[key] = pkg[key];
}
...
let fesm2015Adamant = fs.readFileSync(__dirname + '/../dist/fesm2015/neoskop-phantom.mjs', 'utf8');
...
fs.writeFileSync(__dirname + '/../dist/fesm2015/neoskop-phantom.mjs', fesm2015Adamant);
