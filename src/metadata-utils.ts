...
export const CLASS_METADATA_KEY = '__phantom_class_metadata';
export const PROPERTY_METADATA_KEY = '__phantom_property_metadata';

export function getClassMetadata<T extends {} = any>(target: Ctor<any> | Function, type?: Ctor<T>): T[] {
